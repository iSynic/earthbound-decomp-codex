...
SUBCOMMAND_NAMES: dict[int, dict[int, str]] = {
    ...
    0x19: {
        ...
        0x20: 'LOAD_MUSHROOMIZED_SELECTOR_BYTE',
        0x21: 'IS_ITEM_DRINK',
    ...
    0x1A: {
        ...
        0x0B: 'OPEN_TELEPORT_DESTINATION_MENU',
    },
    0x1B: {
    ...
    0x1F: {
        ...
        0x71: 'REALIZE_PSI',
        0x81: 'CHECK_DIRECT_ITEM_USE_COMPATIBILITY',
        0x83: 'EQUIP_ITEM_TO_CHARACTER',
        0x90: 'BUILD_PHONE_CONTACT_SELECTION_MENU',
