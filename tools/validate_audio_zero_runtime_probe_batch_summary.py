#!/usr/bin/env python3
"""Validate an ignored 0x00 runtime probe batch-run summary."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate audio 0x00 runtime probe batch summary.")
...
def validate(data: dict[str, Any]) -> None:
    require(data.get("schema") == "earthbound-decomp.audio-zero-runtime-probe-batch-run.v1", "unexpected schema")
...
def main() -> int:
    ...
    validate(data)
    print(
        "Audio 0x00 runtime probe batch summary validation OK: "
