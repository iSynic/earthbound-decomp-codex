...
CONTRACT_FAMILIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "next_contract": "Map contracts are phase-good-enough: D7 sector metadata, D8 collision source-emission rows/value counts, DA palette subrecords/script joins, and the DC current-position event-music selector are contract-backed, while D7/DC unresolved planes are value-bounded without promoted names; collision low modifier labels, DA event-palette selector runtime behavior, DF profile names, and remaining D7 high-bit/DC second-plane semantics are deferred caller-evidence polish.",
    },
    {
