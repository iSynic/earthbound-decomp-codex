...
CONTRACT_FAMILIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "next_contract": "Text-window skin, font, town-map, intro/title scene, and SRAM template shapes are split; next polish exact field roles for E1:AE7C/E1:CE08/death-screen tail and SRAM block ownership.",
    },
    {
        "id": "audio_packs",
        "label": "Audio packs",
        ...
        "recommended_next_manual_seams": [
            {
                ...
                "why": "Contract-seeded; text-window skins, font bundles, town-map tables, intro/title visuals, and SRAM template blocks now have splits, so the next useful step is narrow field-role polish rather than another broad E0/E1 bundle pass.",
            },
            {
                "rank": 2,
