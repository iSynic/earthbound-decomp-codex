...
CONTRACT_FAMILIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "proof": "table split manifests, source scaffolds, CF door-data, movement-trigger source-emission, sector-list, and event-music context contracts, and D0 tile-event plus placement/battle variable-list contracts with BTL entry distribution and unpointed-gap accounting cover the highest-risk variable-list subrecords",
        "docs": [
    ...
    },
    {
        ...
        "maturity": "contract-backed-with-known-followups",
        "proof": "map object, sector, D7 sector metadata with source-emission/value-count summaries, DA palette subrecords plus metadata/script usage summaries, DC current-position music selector and bounded second-plane summaries, tileset, FTS, D8 collision subrecords with source-emission/value-count summaries, palette, movement, sprite-usage, DF landing palette-animation profile/payload, and scene-composition contracts exist",
        "docs": [
        ...
        "next_contract": "Map contracts are phase-good-enough: D7 sector metadata source-emission rows/value counts, D8 collision source-emission rows/value counts, DA palette subrecords/script joins, and the DC current-position event-music selector are contract-backed, while D7/DC unresolved planes are value-bounded without promoted names; collision low modifier labels, DA event-palette selector runtime behavior, DF profile names, and remaining D7 high-bit/DC second-plane semantics are deferred caller-evidence polish.",
    },
    {
    ...
    return {
        ...
        "recommended_next_manual_seams": [
            ...
            },
            {
                ...
                "why": "The map milestone is phase-good-enough; D7 unresolved planes now have numeric-preserve source-emission policy, while DC unresolved planes and DA event-palette selector dispatch remain bounded runtime-semantics polish.",
            },
            {
                "rank": 4,
                "family": "audio_packs",
