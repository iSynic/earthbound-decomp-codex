...
CONTRACT_FAMILIES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "proof": "table split manifests, source scaffolds, CF sector-list and event-music context contracts, and D0 tile-event plus placement/battle variable-list contracts account for bytes and the highest-risk variable-list subrecords",
        "docs": [
        ...
        "next_contract": "CF/D0 table contracts are now useful for source planning; remaining polish is CF DOOR_DATA payload decoding and generated source-emission polish.",
    },
    {
