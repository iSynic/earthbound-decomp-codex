...
ORACLES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "addresses": [
            "C2:40A4", "C2:3D05", "D5:7B68",
            "C0:B9B4", "C2:2F38", "C2:E8E0", "C2:E9C8", "C0:52AA",
            "C2:4821", "C2:488C", "C2:48E0", "C2:492D", "C2:4949",
            "C2:4958", "C2:4A00", "C2:4A2D", "C2:4A79", "C2:4A8A",
            "C2:4B5C", "C2:4CD5", "C2:4CEF", "C2:4EEC", "C2:4EF6", "C2:4F03",
            "C2:4A6B", "C2:4F52", "C2:4FCF", "C2:5024", "C2:5619",
            "C2:5AFB", "C2:5C30", "C2:5C8C", "C2:5D2B", "C2:5D3D",
            "C2:6081", "C2:6088", "C2:6093", "C2:6145", "C1:DD3B",
            "C1:DD47", "C1:04EE", "C1:0528", "C1:0536", "C1:0644",
            "C1:0772", "C1:078B", "C1:DC1C", "C3:E4EF", "C3:E4FE",
            "C3:E512", "C3:E51F", "C0:1EDE"
        ],
        ...
        "route_groups": {
            "payload_applicator": {
                ...
                "watch_hints": [
                    "$1E/$20 second pointer",
                    "$00BC/$00BE payload pointer",
                    "$A21C target mask domain",
                    "$9FAC selected target rows",
                    "$A970/$A972 active row pointers",
                    "$A96C/$A96E current target mask",
            ...
            "scripted_entry_startup": {
                ...
                "role": "fixture-ROM autostart provenance and battle-routine entry checks for no-save scripted battle runs",
                "status": "reachability_hint_only",
                "next_probe_goal": "Use only to smoke-test generated fixture ROMs that hook C0:B9B4 into C2:2F38, including whether C0:52AA enters BATTLE_ROUTINE and whether the battle text-window create path returns to C2:4EF6; these hits do not replace the C2:40A4 minimum.",
                "probe_breakpoint_hints": [
                    "C0:B9B4", "C2:2F38", "C2:E8E0", "C2:E9C8", "C0:52AA",
                    "C2:4821", "C2:488C", "C2:48E0", "C2:492D", "C2:4949",
                    "C2:4958", "C2:4A00", "C2:4A2D", "C2:4A79", "C2:4A8A",
                ...
                "watch_hints": [
                    "$4DC2 BATTLE_MODE",
                    "$986F GAME_STATE party_members",
                    "$98A3/$98A4 party counts",
                    "$99CE PARTY_CHARACTERS/BATTLERS_TABLE seed rows",
                    "$8654/$86A6/$86F8... window record allocation markers",
                    "$88E0/$88E2 active window descriptor head/tail",
                    "$8900 logical slot 0x000E window-record map entry",
        ...
        "capture_fields": [
            "action_row_id",
            "second_pointer",
            "c2_40a4.static_callsite",
            "c2_40a4.caller_frame_second_payload_pointer",
            "c2_40a4.current_action_payload_pointer",
            "c2_40a4.current_target_mask_before_after",
            "c2_40a4.active_attacker_target_rows",
            "c2_40a4.effect_busy_gate",
            "target_mask_low",
            "target_mask_high",
    ...
    },
    {
        ...
        "addresses": [
            "C2:8125", "C2:7550", "C2:7680", "C2:77CA", "C2:BB18", "C2:BC5C", "C1:DC1C", "C1:DC66",
            "C0:B9B4", "C2:2F38", "C2:E8E0", "C2:E9C8", "C0:52AA",
            "C2:4821", "C2:488C", "C2:48E0", "C2:492D", "C2:4949",
            "C2:4958", "C2:4A00", "C2:4A2D", "C2:4CEF", "C2:4EEC",
            "C2:4EF6", "C2:4F03", "C2:4F52", "C2:4FCF", "C2:5024",
            "C2:5619", "C2:5AFB", "C2:5C30", "C2:5C8C", "C2:5D2B",
            "C2:5D3D", "C2:6081", "C2:6088", "C2:6093", "C2:6145",
        ],
        "route_groups": {
            "collapse_tail": {
                "addresses": ["C2:8125", "C2:7550", "C2:7680", "C2:77CA", "C2:BB18", "C1:DC1C", "C1:DC66"],
                "role": "natural damage, HP roller, collapse setup, and result-text path",
                "status": "proof_grade_core_with_optional_tail_open",
                "next_probe_goal": "Find a row state that reaches descriptor death text C2:7680 rather than the C2:77CA direct collapse controller tail.",
            },
            "scripted_entry_cleanup_tail": {
                "addresses": [
                    "C0:B9B4", "C2:2F38", "C2:E8E0", "C2:E9C8", "C0:52AA",
                    "C2:4821", "C2:488C", "C2:48E0", "C2:492D", "C2:4949",
                    "C2:4958", "C2:4A00", "C2:4A2D", "C2:4CEF", "C2:4EEC",
                    "C2:4EF6", "C2:4F03", "C2:4F52", "C2:4FCF", "C2:5024",
                    "C2:5619", "C2:5AFB", "C2:5C30", "C2:5C8C", "C2:5D2B",
                    "C2:5D3D", "C2:6081", "C2:6088", "C2:6093", "C2:6145", "C2:BC5C",
                ],
                "role": "scripted-entry battle-start controller route to inactive live-slot cleanup",
                "status": "fixture_navigation_only_until_c2_bc5c_observed",
                "next_probe_goal": "Use generated scripted-entry fixture ROMs to reach C2:6145 -> C2:BC5C, then seed one inactive/live-slot pair before claiming cleanup mechanics.",
                "watch_hints": [
                    "$4DC2 BATTLE_MODE",
                    "$9FAC candidate source rows",
                    "$99CE linked live battler row",
                    "row +0x10/+0x11/+0x12/+0x14 transient live-slot fields",
                ],
            },
        },
        "diary_entries": [8],
    ...
    },
    {
        ...
        "addresses": [
            "C2:8E42", "C2:9F5E", "C2:9FE1", "C2:7191", "C2:721D", "C2:7318", "C2:B360",
            "C0:B9B4", "C2:2F38", "C2:E8E0", "C2:E9C8", "C0:52AA",
            "C2:4821", "C2:488C", "C2:48E0", "C2:492D", "C2:4949",
            "C2:4958", "C2:4A00", "C2:4A2D", "C2:4CEF", "C2:4EEC",
            "C2:4EF6", "C2:4F03", "C2:4F52", "C2:4FCF", "C2:5024",
            "C2:5619", "C2:5AFB", "C2:5C30", "C2:5C8C", "C2:5D2B",
            "C2:5D3D", "C2:6081", "C2:6088", "C1:DD3B", "C1:DD47",
            "C1:04EE", "C1:0528", "C1:0536", "C1:0644", "C1:0772",
            "C1:078B", "C1:DC1C", "C3:E4EF", "C3:E4FE", "C3:E512",
            "C3:E51F", "C0:1EDE",
        ],
        "diary_entries": [16, 18],
        "route_groups": {
            "scripted_entry_startup": {
                ...
                "role": "fixture-ROM autostart provenance for no-save resource-action scripted battle runs",
                "status": "reachability_hint_only",
                "next_probe_goal": (
                    "Use only to smoke-test resource fixture ROMs that hook C0:B9B4 into C2:2F38; "
                    "these startup hits enable delayed WRAM seeding but do not replace C2:9F5E/C2:8E42 minimums."
                ),
                "probe_breakpoint_hints": [
                    "C0:B9B4", "C2:2F38", "C2:E8E0", "C2:E9C8", "C0:52AA",
                    "C2:4821", "C2:488C", "C2:48E0", "C2:492D", "C2:4949",
                ...
                "watch_hints": [
                    "$986F GAME_STATE party_members",
                    "$99CE live party rows",
                    "$9FAC battler rows",
                    "$A970/$A972 active attacker/target row pointers",
                    "$88E0/$8958 window state used by cold-boot battle entry",
                ],
            },
        },
        "capture_fields": [
        ...
        "evidence_notes": [
            ...
            "notes/c2-save-state-battler-scout.md",
