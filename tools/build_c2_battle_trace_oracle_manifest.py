...
ORACLES: list[dict[str, Any]] = [
    {
        ...
        "route_groups": {
            ...
            "snapshot_export": {
                ...
                "next_probe_goal": "Run from a party-side selected-target/action confirmation state until the snapshot export breakpoint fires before the C2:BAC5 count loop repeats.",
                "probe_breakpoint_hints": ["C1:B3DB", "C1:B462", "C1:B505", "C1:B859", "C1:B9A9", "C1:BA60", "C2:B930"],
                "watch_hints": ["registers A/X/Y", "$9FFA..$A047 snapshot block", "$9FAC candidate rows", "$A970/$A972 selected row pointers"],
            },
        },
        "capture_fields": [
            "input_action_id",
