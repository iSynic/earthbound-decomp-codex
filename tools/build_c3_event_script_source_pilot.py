...
FAMILY_DEFAULTS = {
    ...
    "service-event-movement": {
        ...
        "next": "Inspect `C3:48C4..C3:4964` as the next source-form candidate and decide whether it belongs with these service-event movement scripts or starts a neighboring service animation family.",
    },
}
