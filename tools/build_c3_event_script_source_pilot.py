...
LABEL_OVERRIDES = {
    ...
    "C3:8FCE": "Event744_TownHallMovementTextPath",
...
FAMILY_DEFAULTS = {
    ...
    "position-watch-new-entity-paths": {
        ...
        "next": "Continue with another high-ranked ready seam from `notes/c3-source-pilot-frontier.md`; the adjacent `C3:D1C9..C3:D913` continuation should wait until the `C0:A8B3` callroutine contract is pinned.",
    },
    "townhall-direction-common-paths": {
        ...
        "next": "Continue with another high-ranked ready seam from `notes/c3-source-pilot-frontier.md`; the adjacent `C3:8FCE..C3:9AC7` continuation should wait until the `C4:9841` callroutine contract is pinned.",
    },
