...
FAMILY_DEFAULTS = {
    ...
    "service-animation-helpers": {
        ...
        "next": "Inspect `C3:4D39..C3:4E73` as the next source-form candidate. It starts after the event 569 presentation path and before the larger `C3:4E73` event payload cluster.",
    },
}
