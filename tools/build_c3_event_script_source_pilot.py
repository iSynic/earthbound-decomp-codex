...
FAMILY_DEFAULTS = {
    ...
    "itoi-production-intro": {
        ...
        "next": "Continue the split at `C3:4FC7`, starting with event 539 and the subsequent event 540-546 movement paths before deciding how to group scripts 799-801.",
    },
}
