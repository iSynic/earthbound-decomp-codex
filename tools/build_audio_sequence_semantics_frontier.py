...
COMMAND_HYPOTHESES: dict[int, dict[str, str]] = {
    ...
    0xE0: {"name": "instrument", "confidence": "source_backed"},
    0xE1: {"name": "pan", "confidence": "source_backed"},
    0xE2: {"name": "pan_fade", "confidence": "source_backed"},
    0xE3: {"name": "vibrato", "confidence": "source_backed"},
    0xE4: {"name": "vibrato_off", "confidence": "source_backed"},
    0xE5: {"name": "volume", "confidence": "source_backed"},
    0xE6: {"name": "volume_fade", "confidence": "source_backed"},
    0xE7: {"name": "tempo", "confidence": "source_backed"},
    0xE8: {"name": "tempo_fade", "confidence": "source_backed"},
    0xE9: {"name": "transpose", "confidence": "source_backed"},
    0xEA: {"name": "voice_transpose", "confidence": "source_backed"},
    0xEB: {"name": "tremolo", "confidence": "source_backed"},
    0xEC: {"name": "tremolo_off", "confidence": "source_backed"},
    0xED: {"name": "voice_volume", "confidence": "source_backed"},
    0xEE: {"name": "voice_volume_fade", "confidence": "source_backed"},
    0xEF: {"name": "subroutine", "confidence": "source_backed"},
    0xF0: {"name": "vibrato_fade", "confidence": "source_backed"},
    0xF1: {"name": "portamento_to", "confidence": "source_backed"},
    0xF2: {"name": "portamento_from", "confidence": "source_backed"},
    0xF3: {"name": "portamento_off", "confidence": "source_backed"},
    0xF4: {"name": "detune", "confidence": "source_backed"},
    0xF5: {"name": "echo_volume", "confidence": "source_backed"},
    0xF6: {"name": "echo_off", "confidence": "source_backed"},
    0xF7: {"name": "echo_parameters", "confidence": "source_backed"},
    0xF8: {"name": "echo_volume_fade", "confidence": "source_backed"},
    0xF9: {"name": "note_slide", "confidence": "source_backed"},
    0xFA: {"name": "percussion_instrument", "confidence": "source_backed"},
    0xFB: {"name": "nop", "confidence": "source_backed"},
    0xFC: {"name": "mute_voice", "confidence": "source_backed"},
    0xFD: {"name": "fast_forward", "confidence": "source_backed"},
    0xFE: {"name": "fast_forward_off", "confidence": "source_backed"},
