...
SCENES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "label": "Death-screen visual tail",
        ...
        "refs": [
            "refs/eb-decompile-4ef92/Logos/DeathScreen_Ness.png",
...
def build_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "scope": "Bank E1 intro logos, War on Giygas/gas-station visuals, attract cards, title screen, and death-screen visual tail",
        "inputs": {
