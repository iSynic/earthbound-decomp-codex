...
def build_triage() -> list[BankTriage]:
    rows: list[BankTriage] = [
        ...
        entry(
            ...
            "source-integration-ready",
            1,
            "Promote high-traffic C1 text/menu/file-select labels and pair them with C2/C4/EF contracts before source extraction.",
    ...
    rows.append(
        entry(
            ...
            1,
            "Split EF into save/SRAM source, map tileset/sprite grouping tables, text/help script runs, glyph mask tables, debug/menu routines, and named late tail data.",
