...
def build_manifest(input_path: Path = DEFAULT_INPUT) -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "policy": {
            ...
            "natural_c1_route_proven_in_this_result": False,
    ...
    manifest.update(
        {
            ...
            "controlled_result_limits": controlled_limits,
        }
    )
    return manifest
...
def render_note(manifest: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- natural C1 route proven in this result: `{summary.get('natural_c1_route_proven_in_this_result')}`",
    ...
    lines.extend(f"- {gap}" for gap in manifest.get("controlled_result_limits", []))
    lines.extend(
        [
            "",
            "## Runner Follow-Up",
            ...
            f"- natural C1 route proven in this result: `{policy.get('natural_c1_route_proven_in_this_result')}`",
