...
import build_asset_output_recipe_option_audit
...
def build_checked_reports(manifest_dir: Path, *, include_codec: bool) -> list[CheckedReport]:
    ...
    recipe_option_audit = build_asset_output_recipe_option_audit.build_report(manifest_dir)
    reports.append(
        CheckedReport(
            build_asset_output_recipe_option_audit.DEFAULT_MARKDOWN_OUT,
            build_asset_output_recipe_option_audit.render_markdown(recipe_option_audit),
            "python tools/build_asset_output_recipe_option_audit.py",
            recipe_option_audit,
        )
    )
