...
MECHANISMS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "natural_keywords": ("hp-rolling", "paula-freeze", "earthbound-usa-7", "earthbound-usa-8", "hp-sucker"),
    ...
    },
    {
        ...
        "oracle": "c2_8125_damage_abi_boundary",
        "natural_keywords": ("large-pizza", "goods-menu", "hp-sucker"),
        "required_hits": ("C2:8125",),
        "success_status": "natural_proof_candidate",
        "next_action": "Use Large Pizza and HP-Sucker natural saves to join item action, HP amount, and text payload.",
    },
    {
    ...
    },
    {
        ...
        "natural_keywords": ("flash", "numb", "stonehenge", "mighty-bear-seven"),
        "required_hits": ("C2:9917", "C2:724A"),
        "success_status": "natural_proof_candidate",
        "next_action": "Review natural Mighty Bear Seven Flash capture: C2:98A1 -> C2:9917 -> C2:724A writes selected-row +0x1D from 0 to 3, confirming the English body-numb branch; Mook Senior Flash also covers C2:9950 -> C2:724A crying.",
    },
    {
        ...
        "natural_keywords": ("large-pizza", "paula-freeze", "ness-healing", "before-damage", "hp-sucker"),
        "required_hits": ("C1:DC66", "C1:AD0A", "C1:7EED", "C1:AD26", "C1:0DF6"),
        "success_status": "natural_proof_candidate",
        "next_action": "Review fallback C2:8125 C1 amount-payload joins, including HP-Sucker EF:75AB; keep dedicated battle_text_payload_join oracle unresolved.",
    },
]
