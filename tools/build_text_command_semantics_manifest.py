...
AUTHORING_HINTS = {
    ...
    "@RESF": {"opcode": "0x05", "name": "CLEAR_EVENT_FLAG", "confidence": "medium"},
    "@CHKF": {"opcode": "0x07", "name": "CHECK_EVENT_FLAG", "confidence": "high"},
    ...
    "@MUSISTART": {"opcode": "0x1F", "subopcode": "0x00", "name": "PLAY_MUSIC", "confidence": "medium"},
    "@MUSI_START": {"opcode": "0x1F", "subopcode": "0x00", "name": "PLAY_MUSIC", "confidence": "medium"},
    ...
    "@GOTO": {"opcode": "0x0A", "name": "JUMP", "confidence": "high"},
    "@TRUE_GOTO": {"opcode": "0x1B", "subopcode": "0x03", "name": "JUMP_IF_TRUE", "confidence": "medium"},
    "@FALSE_GOTO": {"opcode": "0x1B", "subopcode": "0x02", "name": "JUMP_IF_FALSE", "confidence": "medium"},
    "@CLOSE": {"opcode": "0x18", "subopcode": "0x00", "name": "CLOSE_WINDOW", "confidence": "high"},
    "@SAVE_WIN": {"opcode": "0x18", "subopcode": "0x02", "name": "SAVE_WINDOW_STATE", "confidence": "medium"},
    "@SELECT_WIN": {"opcode": "0x18", "subopcode": "0x03", "name": "SWITCH_TO_WINDOW", "confidence": "medium"},
    "@CLS": {"opcode": "0x18", "subopcode": "0x06", "name": "CLEAR_WINDOW", "confidence": "medium"},
    "@DSP_ITEM": {"opcode": "0x1C", "subopcode": "0x05", "name": "PRINT_ITEM_NAME", "confidence": "medium"},
    "@DSP_NUM": {"opcode": "0x1C", "subopcode": "0x0A", "name": "PRINT_NUMBER", "confidence": "medium"},
    "@DSP_CNUM": {"opcode": "0x1C", "subopcode": "0x0A", "name": "PRINT_NUMBER", "confidence": "low"},
    "@DSP_PSI": {"opcode": "0x1C", "subopcode": "0x12", "name": "PRINT_PSI_NAME", "confidence": "medium"},
    "@DSP_CHAR": {"opcode": "0x1C", "subopcode": "0x03", "name": "PRINT_CHAR", "confidence": "medium"},
    "@GET_CNUM": {"opcode": "0x19", "subopcode": "0x10", "name": "GET_CHARACTER_NUMBER", "confidence": "medium"},
    "@GET_STS_CHAR": {"opcode": "0x19", "subopcode": "0x16", "name": "GET_CHARACTER_STATUS", "confidence": "medium"},
    "@GET_NEXTLEVEL": {"opcode": "0x19", "subopcode": "0x18", "name": "GET_EXPERIENCE_NEEDED_TO_LEVEL_UP", "confidence": "medium"},
    "@GET_MEMBERS": {"opcode": "0x1D", "subopcode": "0x19", "name": "HAVE_X_PARTY_MEMBERS", "confidence": "low"},
    "@BGMSTOP": {"opcode": "0x1F", "subopcode": "0x01", "name": "STOP_MUSIC", "confidence": "high"},
    "@MESSAGE_SOUND": {"opcode": "0x1F", "subopcode": "0x04", "name": "SET_TEXT_PRINTING_SOUND", "confidence": "high"},
    "@DIS_BGMCHG": {"opcode": "0x1F", "subopcode": "0x05", "name": "DISABLE_SECTOR_MUSIC_CHANGE", "confidence": "high"},
    "@ENA_BGMCHG": {"opcode": "0x1F", "subopcode": "0x06", "name": "ENABLE_SECTOR_MUSIC_CHANGE", "confidence": "high"},
    "@BGM_EFFECT": {"opcode": "0x1F", "subopcode": "0x07", "name": "APPLY_MUSIC_EFFECT", "confidence": "medium"},
    "@ADD_PARTY": {"opcode": "0x1F", "subopcode": "0x11", "name": "ADD_PARTY_MEMBER", "confidence": "high"},
    "@DEL_PARTY": {"opcode": "0x1F", "subopcode": "0x12", "name": "REMOVE_PARTY_MEMBER", "confidence": "high"},
    "@SET_PARTY_DIR": {"opcode": "0x1F", "subopcode": "0x14", "name": "CHANGE_PARTY_DIRECTION", "confidence": "medium"},
    "@BATTLE": {"opcode": "0x1F", "subopcode": "0x23", "name": "TRIGGER_BATTLE", "confidence": "high"},
    "@SAVE_GAME": {"opcode": "0x1F", "subopcode": "0xB0", "name": "SAVE_GAME", "confidence": "high"},
    "@DISKEY": {"opcode": "0x1F", "subopcode": "0x50", "name": "DISABLE_CONTROLLER_INPUT", "confidence": "medium"},
    "@ADD_PSI": {"opcode": "0x1F", "subopcode": "0x71", "name": "REALIZE_PSI", "confidence": "medium"},
    "@TAKE_PHOTO": {"opcode": "0x1F", "subopcode": "0xD2", "name": "SUMMON_WANDERING_PHOTOGRAPHER", "confidence": "medium"},
    "@SET_PALLETSET": {"opcode": "0x1F", "subopcode": "0xE1", "name": "CHANGE_MAP_PALETTE", "confidence": "medium"},
    "@RIDE_CYCLE": {"opcode": "0x1F", "subopcode": "0xF0", "name": "RIDE_BICYCLE", "confidence": "high"},
    "@GOODSIN": {"opcode": "0x1D", "subopcode": "0x00", "name": "GIVE_ITEM_TO_CHARACTER", "confidence": "medium"},
    "@GOODSIN_PLAYER": {"opcode": "0x1D", "subopcode": "0x00", "name": "GIVE_ITEM_TO_CHARACTER", "confidence": "medium"},
    "@GOODSOUT": {"opcode": "0x1D", "subopcode": "0x01", "name": "TAKE_ITEM_FROM_CHARACTER", "confidence": "medium"},
    "@GOODSOUT_PLAYER": {"opcode": "0x1D", "subopcode": "0x01", "name": "TAKE_ITEM_FROM_CHARACTER", "confidence": "medium"},
    "@Q_GOODSFULL": {"opcode": "0x1D", "subopcode": "0x03", "name": "GET_PLAYER_HAS_INVENTORY_ROOM", "confidence": "medium"},
    "@Q_HAVE": {"opcode": "0x1D", "subopcode": "0x05", "name": "CHECK_IF_CHARACTER_HAS_ITEM", "confidence": "medium"},
    "@DEPOSIT_MONEY_BANK": {"opcode": "0x1D", "subopcode": "0x06", "name": "ADD_TO_ATM", "confidence": "medium"},
    "@DRAW_MONEY_BANK": {"opcode": "0x1D", "subopcode": "0x07", "name": "TAKE_FROM_ATM", "confidence": "medium"},
    "@MONEYIN": {"opcode": "0x1D", "subopcode": "0x08", "name": "ADD_TO_WALLET", "confidence": "medium"},
    "@MONEYOUT": {"opcode": "0x1D", "subopcode": "0x09", "name": "TAKE_FROM_WALLET", "confidence": "medium"},
    "@Q_MONEY": {"opcode": "0x1D", "subopcode": "0x14", "name": "HAVE_ENOUGH_MONEY", "confidence": "medium"},
    "@Q_BANK_MONEY": {"opcode": "0x1D", "subopcode": "0x17", "name": "HAVE_ENOUGH_MONEY_IN_ATM", "confidence": "medium"},
    "@Q_MEMBER": {"opcode": "0x1D", "subopcode": "0x19", "name": "HAVE_X_PARTY_MEMBERS", "confidence": "medium"},
    "@RAND": {"opcode": "0x1D", "subopcode": "0x21", "name": "GENERATE_RANDOM_NUMBER", "confidence": "medium"},
    "@Q_EQUIP": {"opcode": "0x1D", "subopcode": "0x10", "name": "CHECK_ITEM_EQUIPPED", "confidence": "medium"},
    "@CLRLINE": {"opcode": "0x12", "name": "CLEAR_TEXT_LINE", "confidence": "high"},
    "@HP_UP": {"opcode": "0x1E", "subopcode": "0x02", "name": "RECOVER_HP_AMOUNT", "confidence": "medium"},
    "@HP_DOWN": {"opcode": "0x1E", "subopcode": "0x03", "name": "DEPLETE_HP_AMOUNT", "confidence": "medium"},
    "@PP_UP": {"opcode": "0x1E", "subopcode": "0x06", "name": "RECOVER_PP_AMOUNT", "confidence": "medium"},
    "@PP_DOWN": {"opcode": "0x1E", "subopcode": "0x07", "name": "DEPLETE_PP_AMOUNT", "confidence": "medium"},
    "@SET_LEVEL": {"opcode": "0x1E", "subopcode": "0x08", "name": "SET_CHARACTER_LEVEL", "confidence": "medium"},
    "@EXP_UP_POINT": {"opcode": "0x1E", "subopcode": "0x09", "name": "GIVE_EXPERIENCE", "confidence": "medium"},
    "@IQ_UP_POINT": {"opcode": "0x1E", "subopcode": "0x0A", "name": "BOOST_IQ", "confidence": "medium"},
    "@GUTS_UP_POINT": {"opcode": "0x1E", "subopcode": "0x0B", "name": "BOOST_GUTS", "confidence": "medium"},
    "@SPEED_UP_POINT": {"opcode": "0x1E", "subopcode": "0x0C", "name": "BOOST_SPEED", "confidence": "medium"},
    "@VITAL_UP_POINT": {"opcode": "0x1E", "subopcode": "0x0D", "name": "BOOST_VITALITY", "confidence": "medium"},
    "@LUCK_UP_POINT": {"opcode": "0x1E", "subopcode": "0x0E", "name": "BOOST_LUCK", "confidence": "medium"},
}
