...
; Unmodified, the binary is byte-accurate to the engine.bin
; decompiled by CoilSnake.
...
L_0779:         asl   a                         ; 1C
L_077A:         mov   x, a                      ; 5D
L_077B:         mov   a, $2E49+x                ; F5 49 2E
L_077E:         mov   y, a                      ; FD
L_077F:         mov   a, $2E48+x                ; F5 48 2E
...
L_079D:         asl   a                         ; 1C
L_079E:         mov   x, a                      ; 5D
L_079F:         mov   a, $2F47+x                ; F5 47 2F
L_07A2:         mov   y, a                      ; FD
L_07A3:         mov   a, $2F46+x                ; F5 46 2F
...
L_0FA7:         dec   a                         ; 9C
L_0FA8:         mov   y, a                      ; FD
L_0FA9:         mov   a, L_1068+y               ; F6 68 10
L_0FAC:         mov   $04D8, a                  ; C5 D8 04
L_0FAF:         inc   y                         ; FC
L_0FB0:         mov   a, L_1068+y               ; F6 68 10
...
; TODO: Note lengths + hold lengths??
L_1068:         db $03, $01 ; 01
                db $03, $02 ; 03
                db $06, $02 ; 05
                db $06, $05 ; 07
...
L_11E4:         mov.b $24, #L_16C7              ; 8F C7 24
L_11E7:         mov.b $25, #L_16C7>>8           ; 8F 16 25
...
L_16C7:         dw SFX_01 ; 001 [01] (Menu confirm)
                ...
                dw SFX_5E ; 094 [5E] (Name input unknown)
