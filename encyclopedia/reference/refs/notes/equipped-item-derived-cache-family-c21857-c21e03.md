# Equipped-Item Derived Cache Family `C2:1857..2213`
...
The helpers at `C2:1857`, `C2:192B`, `C2:1AEB`, `C2:1BA4`, `C2:1C5D`, `C2:1D65`, `C2:1D7D`, `C2:1D95`, `C2:1E03`, `C2:1F38`, `C2:2028`, `C2:20C7`, and `C2:21B7` are best read as a shared equipped-item derived-cache family over the character record.
