...
C23979_C2311B_RunBattleStartPresentAndMessageController_L3979:
    ...
    sta BattleActionSelectionActorId
    rep #$20
    ; C1:CFC6/C1:CE85 fill the shared action-selection record with the
    ; chosen item slot, resolved action word, and target bytes.
...
C23A88_C2311B_RunBattleStartPresentAndMessageController_L3A88:
    ; Final Prayer phases 4..12 map directly to action-table rows 0x123..0x12B.
