...
; C3:F819..C3:F981 is protected as a data gap in
; build/c3-build-candidate-ranges.json and emitted by the scaffold translator
; before the dispatch entry below.
