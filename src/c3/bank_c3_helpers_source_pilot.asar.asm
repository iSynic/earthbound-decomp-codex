...
; Durable C3 bank source-pilot scaffold variant.
;
; This file keeps the canonical C3 bank scaffold untouched while proving
; that the event/actionscript source-pilot scaffold can replace the old
; opaque C3:0000..E450 corridor in a whole-bank assembly.

incsrc "src/c3/bank_c3_event_scripts_source_pilot.asar.asm"

; Generated by tools/build_c3_source_pilot_bank_scaffold.py
; Durable C3 bank scaffold variant with event/actionscript source-pilot corridor.
;
