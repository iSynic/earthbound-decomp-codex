...
8. `C4:B26B` plus `C4:B1B8`, `C4:B3D0 / C4:B4BE`, and `C0:AC43 / AC68+ / ACE6+ / AD26+`
   - initialize graphics transfer and child-anchor state, dispatch among timed control streams, resolve per-record queue assignment word `$103E`, then feed one of four renderer queue families
9. `C08B8E+ / C08CD5`
