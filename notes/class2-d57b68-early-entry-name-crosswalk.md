...
The next late none-target slice is no longer a generic event bucket either.

- entry `0x0123` (`291`) -> `C2:C572` -> strongest current local fit for `FINAL_PRAYER_1`
- entry `0x0124` (`292`) -> `C2:C5D1` -> strongest current local fit for `FINAL_PRAYER_2`
- entry `0x0125` (`293`) -> `C2:C5FA` -> strongest current local fit for `FINAL_PRAYER_3`
- entry `0x0126` (`294`) -> `C2:C623` -> strongest current local fit for `FINAL_PRAYER_4`
- entry `0x0127` (`295`) -> `C2:C64C` -> strongest current local fit for `FINAL_PRAYER_5`
- entry `0x0128` (`296`) -> `C2:C675` -> strongest current local fit for `FINAL_PRAYER_6`
- entry `0x0129` (`297`) -> `C2:C69E` -> strongest current local fit for `FINAL_PRAYER_7`
