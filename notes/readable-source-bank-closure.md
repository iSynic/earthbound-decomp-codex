...
- decoded asm bytes: `244675`
- preserved corridor bytes: `60459`
- known data/text/table/asset bytes: `22546`
- readable source percent, excluding known data/assets: `80.19%`
...
| `EF` | 0 | 60326 | 5210 | 0.0% | `EF:0000..EF:EB5F` (60255 bytes) |

## Largest Preserved Corridors

| Bank | Range | Bytes | Source Path | Reason | Next Action |
| --- | --- | ---: | --- | --- | --- |
| `EF` | `EF:0000..EF:EB5F` | 60255 | `src/ef/table_002_unknown_ef_ef00bb_asm.asm` | path/subsystem carries preserved or unknown corridor hint | Split EF front run into save/debug/text/table source and data contracts. |
