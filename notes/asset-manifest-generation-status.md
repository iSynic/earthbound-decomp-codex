...
- Map `.fts` format audits now confirm all `20` direct EBDecomp exports share a stable `64/290/96` section shape: `1024` high-confidence 8x8 indexed tile rows, `1-52` variable settings rows, and `1024` arrangement/collision records.
