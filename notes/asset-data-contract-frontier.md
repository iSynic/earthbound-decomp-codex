...
- assets with decoder recipes beyond raw extraction: `1972`
- manifests with typed output summaries: `38`
- banks linked to smoke fixtures: `23`
- smoke fixture links from manifests: `87`
...
- output recipe mix: `raw` 689, `earthbound_lzhal` 361, `earthbound_lzhal_snes_4bpp_tiles_palette_png` 234, `earthbound_lzhal_snes_4bpp_tiles_png` 202, +5 more
...
- output recipe mix: `raw` 69, `earthbound_lzhal` 41, `earthbound_lzhal_snes_4bpp_tiles_png` 13, `earthbound_lzhal_snes_palette_json` 10, +5 more
...
| `CE` | `battle_visual_assets` | `contract-seeded` | 220 | 65536 | 702 | `binary-asset` 126, `graphics` 89, `raw-table` 3, +2 more | `raw` 220, `battle_swirl_frame_json` 126, `earthbound_lzhal_battle_sprite_png` 89, +5 more | 86 | 0 |
...
| `E0` | `ui_font_town_map_assets` | `contract-seeded` | 16 | 65536 | 28 | `binary-asset` 8, `graphics` 4, `audio` 2, +2 more | `raw` 16, `earthbound_lzhal` 9, `earthbound_lzhal_snes_4bpp_tiles_png` 1, +2 more | 77 | 0 |
