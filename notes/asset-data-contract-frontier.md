...
| UI, fonts, and town-map assets | `E0, E1` | `contract-seeded` | 68 | 131072 | 91 | 5 | Text-window skin, font, town-map, and intro/title scene shapes are split; next resolve the compressed SRAM mystery payload and field-level polish for E1:AE7C/E1:CE08/death-screen tail. |
...
- checked docs: `notes/ui-font-town-map-asset-contracts.md`, `notes/text-window-skin-bundle-contracts.md`, `notes/font-bundle-contracts.md`, `notes/intro-title-visual-bundle-contracts.md`, `notes/bank-e0-asset-data-map.md`, `notes/bank-e1-asset-data-map.md`, `notes/town-map-selection-rendering-c4d274-c4d744.md`, `notes/your-sanctuary-location-coordinate-table-c4de78.md`
...
1. `ui_font_town_map_assets`: Contract-seeded; text-window skins, font bundles, town-map tables, and intro/title visuals now have splits, so the next useful step is the compressed SRAM mystery payload or narrow E1 field-role polish.
