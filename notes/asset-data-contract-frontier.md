...
| Mixed asset/table banks | `CF, D0` | `contract-backed-with-known-followups` | 7 | 131072 | 95 | 0 | 0 | 0 | CF/D0 table contracts are now useful for source planning; remaining polish is CF row-source emission and D0 MAP_TILE_EVENT chain decoding. |
