...
| Map tilesets and runtime tables | `D6, D7, D8, D9, DA, DB, DC, DD, DE, DF` | `contract-backed-with-known-followups` | 130 | 655360 | 1456 | 0 | 0 | 0 | Map contracts are phase-good-enough: D7 generated map metadata split, collision low modifier labels, DA palette metadata/event-selector runtime behavior, and DF profile names are bounded deferred semantic polish. |
