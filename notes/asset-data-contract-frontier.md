...
- assets with decoder recipes beyond raw extraction: `1979`
- manifests with typed output summaries: `38`
- banks linked to smoke fixtures: `23`
- smoke fixture links from manifests: `93`
...
- output recipe mix: `raw` 689, `earthbound_lzhal` 361, `earthbound_lzhal_snes_4bpp_tiles_palette_png` 234, `earthbound_lzhal_snes_4bpp_tiles_png` 202, +7 more
