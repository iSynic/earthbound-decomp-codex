...
| UI, fonts, and town-map assets | `E0, E1` | `contract-seeded` | 68 | 131072 | 91 | 5 | Text-window skin, font, town-map, intro/title scene, title palette animation, title-letter OAM, and SRAM template shapes are split; next polish exact field roles for the death-screen tail and SRAM block ownership. |
