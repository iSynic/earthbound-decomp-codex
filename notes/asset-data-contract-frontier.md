...
| Mixed asset/table banks | `CF, D0` | `contract-backed-with-known-followups` | 7 | 131072 | 95 | 0 | 0 | 0 | CF/D0 table contracts are now useful for source planning; remaining polish is CF trigger-type 1/3/4/5 parameter naming and generated source-emission polish. |
...
- checked docs: `notes/bank-cf-asset-data-map.md`, `notes/bank-d0-asset-data-map.md`, `notes/cf-door-data-contracts.md`, `notes/cf-sector-list-contracts.md`, `notes/cf-event-music-context-contracts.md`, `notes/d0-tile-event-contracts.md`, `notes/d0-variable-list-contracts.md`
