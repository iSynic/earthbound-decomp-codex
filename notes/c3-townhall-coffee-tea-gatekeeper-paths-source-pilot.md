...
- Known native callback argument schemas render as field-shaped macros: `%EVENT_CALLROUTINE_BATTLE_BG_LAYER1_ID_BATTLE_BG_LAYER2_ID`, `%EVENT_CALLROUTINE_DISPLAY_TRANSITION_MODE_DISPLAY_TRANSITION_X_DISPLAY_TRANSITION_Y`, `%EVENT_CALLROUTINE_EVENT_FLAG`, `%EVENT_CALLROUTINE_FADEIN_EFFECT`, +9.
