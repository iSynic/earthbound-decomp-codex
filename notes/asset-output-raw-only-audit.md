...
- decoder/renderer-backed assets: `1991`
- extract-only assets: `228`
- extract-only bytes: `1222548`
- extract-only categories: `4`
- extract-only banks: `32`
- unsupported output kinds: `0`
- extract-only category mix: `audio` 168, `raw-gap` 31, `raw-table` 27, `raw-preserved-corridor` 2
- extract-only boundary mix: `deferred_audio_pack` 168, `preserved_coverage_gap` 31, `table_semantics` 27, `preserved_corridor` 2
...
| `table_semantics` | 27 | 224168 | Table rows are byte-accounted; row-level decode should wait for caller/runtime context. |
...
| UI, fonts, and town-map assets | 14 | 17977 | `raw-table` 9, `audio` 3, `raw-gap` 2 | `table_semantics` 9, `deferred_audio_pack` 3, `preserved_coverage_gap` 2 |
