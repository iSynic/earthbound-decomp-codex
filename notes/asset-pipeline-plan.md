...
- **Next**: overworld sprite low-bit pointer flag naming, composed overworld directional preview sheets, optional overworld palette variants, palette table splitting, tilemaps, BRR/sample packs, text tables, and map sector data.
...
- `tools/build_overworld_sprite_frame_contract.py` consumes the sprite group contract, the user-supplied ROM, and D1-D5 manifests to resolve EF sprite grouping pointer slots to concrete payload assets for ports and editors.
