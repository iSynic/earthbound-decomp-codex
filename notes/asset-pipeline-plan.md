...
- `tools/build_overworld_sprite_frame_contract.py` consumes the sprite group contract and produces conservative runtime slot/payload layout classifications for ports and editors.
