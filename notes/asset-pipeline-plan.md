...
- `tools/build_map_sprite_usage_contract.py` consumes reference map sprite placements, NPC config rows, the overworld sprite enum, and the animation-role contract to write `notes/map-sprite-usage-contract.json`.
