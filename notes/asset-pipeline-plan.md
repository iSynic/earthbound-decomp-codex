...
- **Done in the base pipeline**: raw ROM slices, LZHAL decompression, 2bpp/4bpp tile preview PNGs, SNES BGR555 palette JSON, palette swatch PNGs, first-pass battle-background palette-aware tile previews, extraction reports.
- **Next**: battle-background arrangement rendering, broader palette-aware tile rendering, palette table splitting, tilemaps, BRR/sample packs, text tables, and map sector data.
