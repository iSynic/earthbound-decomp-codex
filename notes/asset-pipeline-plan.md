...
- `tools/render_map_scene_metatile_previews.py` composes direct `.fts` scenes into ignored grayscale 256x256 sector previews from sector tile IDs, arrangement/collision records, and tile-pixel rows.
