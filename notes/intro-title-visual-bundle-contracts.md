...
- scene bundles: `6`
- manifest components covered: `24`
- source bytes covered: `33006`
- generated local output bytes observed: `457397`
...
- `notes/landing-cast-visual-contracts.md`: Owns the former E1:CFAF..D835 tail as saved-coordinate landing display assets plus ending cast-name visual support.
