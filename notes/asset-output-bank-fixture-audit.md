...
| --- | --- | ---: | --- | --- | --- | --- |
| `CA` | `ok` | 42 | `decoder_only` 23, `renderer` 19 | `asset.ca.battle_background_arr_100` | `earthbound_lzhal_battle_bg_arrangement_png` | `ca/battle_bgs/arrangements/100_composed_preview.png` |
